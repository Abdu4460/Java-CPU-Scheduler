// package com.scheduler.cpu_scheduler;
// import java.util.ArrayList;
// import java.util.Scanner;

// import com.scheduler.cpu_scheduler.models.Task;
// import com.scheduler.cpu_scheduler.scheduling.*;

// public class Driver {

// 	//Creating objects of the necessary classes to use during execution
// 	static FirstComeFirstServe o1 = new FirstComeFirstServe();
// 	static ShortestJobFirst o2 = new ShortestJobFirst();
// 	static PriorityScheduling o3 = new PriorityScheduling();
// 	static RoundRobinScheduling o4 = new RoundRobinScheduling();
...
// 							FirstComeFirstServe.taskList.add(each);
// 						}
// 						flag = false;
// 						o1.schedule();
// 					}
...
// 					{
// 						for(Task each: newList) {
// 							ShortestJobFirst.taskList.add(each);
// 						}
// 						flag = false;
// 						o2.schedule();
// 					}
...
// 						for(Task each: newList) {
// 							RoundRobinScheduling.taskList.add(each);
// 						}
// 						flag = false;
